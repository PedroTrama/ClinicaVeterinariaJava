 ...
 * @author Pedro Trama
 */
public class ScreenConsultasExames extends javax.swing.JFrame {
    ...
    private void initMyComponents() {
        ...
        Controller.setTableModel(jTable1, new TableModelConsulta(ConsultaDAO.getInstance().retrieveAllByTreatmentId(Controller.getSelectedTreatment().getIdTratamento())));
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ScreenNovaConsulta nc = new ScreenNovaConsulta();
        nc.setVisible(true);
        this.dispose();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ScreenTratamento st = new ScreenTratamento();
        st.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ScreenConsultasExames.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ScreenConsultasExames().setVisible(true);
            }
        });
    }
