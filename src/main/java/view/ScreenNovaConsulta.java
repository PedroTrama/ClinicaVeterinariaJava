 ...
 * @author Pedro Trama
 */
public class ScreenNovaConsulta extends javax.swing.JFrame {
    ...
    private void initMyComponents() {
        ...
        Controller.setTableModel(jTable1, new TableModelVeterinario(VeterinarioDAO.getInstance().retrieveAll()));
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        try {
            ...
            Controller.criarConsulta(dt,jTextField1.getText(), jTextArea1.getText());
        } catch (ParseException ex) {
            Logger.getLogger(ScreenNovaConsulta.class.getName()).log(Level.SEVERE, null, ex);
        }
        this.dispose();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
        ((TableModelGenerico) jTable1.getModel()).addItem(Controller.criarVeterinario("", "", ""));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ScreenNovaConsulta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ScreenNovaConsulta().setVisible(true);
            }
        });
    }
